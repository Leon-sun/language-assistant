...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ['user', 'nickname', 'level', 'target_language', 'native_language', 'age_group', 'contact', 'created_at']
    list_filter = ['level', 'target_language', 'native_language', 'age_group', 'interests', 'created_at']
    ...
    fieldsets = (
        ...
        ('Language Preferences', {
            'fields': ('target_language', 'native_language'),
            'description': 'Target language: language the user is learning. Native language: language used for explanations.'
        }),
        ('Profile Details', {
            'fields': ('level', 'age_group', 'interests', 'learning_goals', 'contact')
        }),
        ('Deprecated Fields', {
            'fields': ('interest',),
            'classes': ('collapse',),
...
class ContentCardAdmin(admin.ModelAdmin):
    list_display = ['word', 'target_language', 'target_cefr', 'interest_context', 'tone_style', 'created_at']
    list_filter = ['target_language', 'target_cefr', 'interest_context', 'tone_style', 'created_at']
    ...
    fieldsets = (
        ...
        ('Meta-Tags (Reuse Index)', {
            'fields': ('target_language', 'target_cefr', 'interest_context', 'tone_style')
        }),
        ('Timestamps', {
            'fields': ('created_at', 'updated_at'),
            'classes': ('collapse',)
